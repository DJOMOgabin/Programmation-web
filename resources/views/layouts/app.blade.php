...
<head>
    ...
    <title>{{ config('app.name', 'Annonceur') }}</title>
...
{{--
    <script src="{{asset('https://maps.googleapis.com/maps/api/js?sensor=false&v=3.5')}}" type="text/javascript"></script>
--}}
