...
@section('formulaire')
    <div class="panel-body">
        <form class="col m10 offset-m1" role="form" method="POST" action="{{'save'}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="input-field col m11">
                    <select name="monaie" id="monaie">
                        @foreach($monaies as $monaie)
                            <option value="{{$monaie->name}}">{{$monaie->name}}</option>
                        @endforeach
                    </select>
